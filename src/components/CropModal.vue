      ...
      >
            ...
            <b-row>
              <b-col class="modal-content-size">
                <template v-if="option.img">
                  <vue-cropper id ="cropper" ref="cropper" :src="option.img" :autoCrop="option.autoCrop" :autoCropWidth="option.autoCropWidth"
                    :autoCropHeight="option.autoCropHeight" :aspectRatio="option.aspectRatio" :viewMode="option.viewMode" :rotatable="option.rotatable">
                  </vue-cropper>
                </template>
              </b-col>
            </b-row>
        ...
        <div class="modal-footer justify-content-between">
          <div>
            ...
            <b-button pill variant="outline-warning" @click="rightrotate"><b-icon icon="arrow-clockwise"></b-icon></b-button>
          </div>
          <div>
