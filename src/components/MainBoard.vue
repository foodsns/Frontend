        ...
        <b-col cols="8" style="text-align: left">
          <b-row style="margin-top: 5px;">
            <b-col style="position:relative">
              <span><user-gps-logo ref="userGps" v-b-tooltip.hover.botto.v-secondary title="내 위치" placement = "bottom" @location="onGpsAddrLoaded" @err-msg="onGpsAddrFailed"></user-gps-logo></span>
